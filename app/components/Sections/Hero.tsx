  ...
  return (
    <section id="home" className="min-h-svh flex flex-col justify-center items-center">
      ...
      <div className="hidden md:flex w-full h-svh relative overflow-hidden justify-center items-center">
        ...
        />
        <motion.h2 
          className="absolute inset-0 flex items-center justify-center text-[12.5vw] font-mono tracking-widest font-bold text-background z-10"
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
      ...
      <div className="flex md:hidden w-full h-svh relative overflow-hidden justify-center items-center">
        ...
        />
        <motion.h2 
          className="absolute inset-0 flex items-center justify-center text-[12vw] font-mono tracking-widest font-bold text-background z-10"
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
          transition={{ duration: 7, delay: 0.15 }}
        >
